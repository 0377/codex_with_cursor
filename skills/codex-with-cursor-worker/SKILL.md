---
name: codex-with-cursor-worker
description: Prepare codex-with-cursor worker task files and report requirements for Cursor Agent execution roles.
---

# Codex with Cursor Worker

Read `../codex-with-cursor/CODEX_WITH_CURSOR.md` before preparing a worker task.
