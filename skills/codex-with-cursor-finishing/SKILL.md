---
name: codex-with-cursor-finishing
description: Finish codex-with-cursor workflows by verifying workflow artifacts, session continuity when needed, and final acceptance evidence.
---

# Codex with Cursor Finishing

Read `../codex-with-cursor/CODEX_WITH_CURSOR.md` before finishing a workflow.
