---
name: codex-with-cursor-reviewing
description: Review codex-with-cursor worker reports, verification evidence, changed files, and findings before accepting or returning delegated work.
---

# Codex with Cursor Reviewing

Read `../codex-with-cursor/CODEX_WITH_CURSOR.md` before reviewing delegated results.
