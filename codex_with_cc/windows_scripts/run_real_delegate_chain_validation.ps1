...
- Worker entry script: docs/codex_with_cc/windows_scripts/delegate_to_claude.ps1
...
- Every Claude worker must run inside a child thread with:
  ...
  - fork_context: false
- Every child thread must set CODEX_CLAUDE_CHILD_THREAD=1 and then call docs/codex_with_cc/windows_scripts/delegate_to_claude.ps1 with -TaskFile.
...
- pwsh -NoProfile -File .\docs\codex_with_cc\windows_scripts\verify_delegate_artifacts.ps1 -RunId <anchor-run-id> -ArtifactRoot "$artifactRoot"
- pwsh -NoProfile -File .\docs\codex_with_cc\windows_scripts\verify_delegate_artifacts.ps1 -RunId <parallel-a-run-id> -ArtifactRoot "$artifactRoot"
- pwsh -NoProfile -File .\docs\codex_with_cc\windows_scripts\verify_delegate_artifacts.ps1 -RunId <parallel-b-run-id> -ArtifactRoot "$artifactRoot"
- pwsh -NoProfile -File .\docs\codex_with_cc\windows_scripts\verify_delegate_artifacts.ps1 -RunId <reuse-1-run-id> -ArtifactRoot "$artifactRoot"
- pwsh -NoProfile -File .\docs\codex_with_cc\windows_scripts\verify_delegate_artifacts.ps1 -RunId <reuse-2-run-id> -ArtifactRoot "$artifactRoot"
- pwsh -NoProfile -File .\docs\codex_with_cc\windows_scripts\verify_delegate_chain.ps1 -ArtifactRoot "$artifactRoot" -SessionKey "$SessionKey" -AnchorRunId <anchor-run-id> -ParallelRunIds <parallel-a-run-id>,<parallel-b-run-id> -ReuseRunIds <reuse-1-run-id>,<reuse-2-run-id>
"@
